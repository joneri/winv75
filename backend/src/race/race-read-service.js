    ...
    if (horseIds.length) {
      ...
      const enriched = (race.horses || []).map(horse => {
        ...
        return {
          ...
          ratingLastUpdated: rating?.lastUpdated ?? null,
          ratingLastRaceDate: rating?.lastRaceDate ?? null,
          formRatingLastUpdated: rating?.formLastUpdated ?? null,
          formRatingLastRaceDate: rating?.formLastRaceDate ?? null,
          ...
          storedEloVersion: rating?.eloVersion ?? null,
