...
const DEFAULT_VARIANTS_PER_MODE = Number.isFinite(ENV_VARIANTS_PER_MODE) && ENV_VARIANTS_PER_MODE > 0
  ...
  : 3
export const V86_TEMPLATES = cloneSuggestionTemplates(BASE_SUGGESTION_TEMPLATES)

const templateMap = createSuggestionTemplateMap(V86_TEMPLATES)
